@section('title') BikeShop | ใบสั่งซื้อ @stop
<!DOCTYPE html>
<html lang="en">
    <head>
    <meta charset="utf-8">
    ...
    <body>
            <table border="0" width="100%">
                    ...
                    <tr>
                        <td>
                             <table border="0" width="100%">
                                <tr><td ><strong>ชื้อลูกค้า :</strong></td> <td>{{ $cust_name }}</td></tr>
                                <tr><td ><strong>อีเมล :</strong></td> <td>{{ $cust_email }}</td></tr>
                            </table>
                        </td>
                        <td>
                             <table border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="right"><strong>จำนวนเงินรวมทั้งสิ้น</strong> <h1>{{ number_format($total_amount,2) }} บาท</h1></td>
                    </tr>
                </table>
    </body>
</html>
